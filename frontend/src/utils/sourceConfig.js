export const SOURCE_CONFIG = {
    ...
    sears: { label: 'Sears', color: 'from-sky-500 to-sky-600', icon: '🏪', bg: 'bg-sky-500/10 border-sky-500/30 text-sky-400' },
    costco: { label: 'Costco', color: 'from-red-600 to-blue-600', icon: '📦', bg: 'bg-blue-600/10 border-blue-600/30 text-blue-400' },
