...
export const ELECTRONICS_RULES: PriceGuardRule[] = [
    ...
    { keywords: ['rtx 5080', 'rtx 5090', 'rtx 4090', 'rtx 4080', 'intel core i9', 'core i9', 'core ultra 9', 'ryzen 9'], maxPrice: 130000 },
    { keywords: ['tarjeta de video', 'tarjeta gráfica', 'gpu'], maxPrice: 65000 },

    // --- TIER 3: GAMING LAPTOPS & DESKTOPS ---
    { keywords: ['laptop gamer', 'laptop gaming', 'computadora gamer', 'computadora gaming', 'pc gamer', 'pc gaming', 'xtreme pc', 'grizzly pcg', 'predator', 'legion', 'rog strix', 'tuf gaming', 'omen'], maxPrice: 75000 },
    ...
    // --- TIER 5: PRINTERS & IMAGING (Hardened against false discounts) ---
    { keywords: ['plotter', 'impresora industrial', 'duplicadora'], maxPrice: 60000 },
    { keywords: ['impresora térmica', 'impresora termica', 'qian térmica', 'qian termica', 'mini printer'], maxPrice: 2200 }, // Targets entry POS thermal printers
    { keywords: ['xerox b', 'brother dcp', 'deskjet', 'ink advantage', 'smart tank 5', 'ecotank l3', 'ecotank l1'], maxPrice: 4500 }, // Caps standard home/small office units
    { keywords: ['impresora', 'multifuncional', 'escáner', 'escaner', 'ecotank', 'smart tank', 'laserjet'], maxPrice: 9000 }, // General fallback for heavy color/office tank lines

    // --- TIER 6: PRINTER CONSUMABLES & SUPPLIES (New Guard Line) ---
    { keywords: ['kit de tóner', 'kit de toner', 'paquete de toner', 'tóner pack'], maxPrice: 12000 }, // Enterprise multi-color toner sets
    { keywords: ['tóner', 'toner'], maxPrice: 3200 }, // Single laser toner unit
    { keywords: ['hp 667', 'hp 664', 'hp 67', 'hp 662', 'cartucho de tinta', 'bote de tinta', 'botella de tinta', 'kit bote'], maxPrice: 1200 }, // Individual consumer inks/refill bundles

    // --- TIER 7: MONITOR DISPLAY SYSTEMS (Hardened against false discounts) ---
    ...
    { keywords: ['qian standard', 'sansui standard', 'monitor standard', 'monitor full hd', 'monitor fhd', 'sansui', 'qian', 'ghia', 'acteck', 'vorago'], maxPrice: 3200 }, // Aggressively chokes budget/1080p office displays
    { keywords: ['monitor', 'pantalla para pc'], maxPrice: 12000 }, // Valid high-end designer/creator monitors (Dell UltraSharp, ASUS ProArt)
    ...
    { keywords: ['iphone 17 pro', 'iphone 16 pro', 'iphone 15 pro'], maxPrice: 45000 },
    { keywords: ['iphone', 'galaxy s'], maxPrice: 32000 },
    { keywords: ['smartphone', 'celular', 'teléfono', 'telefono'], maxPrice: 18000 },

    // --- TIER 10: TELEVISIONS ---
    { keywords: ['microled', '8k'], maxPrice: 400000 },
    { keywords: ['oled tv', 'qled tv', 'miniled tv', 'lg oled evo', 'televisión oled', 'television oled'], maxPrice: 150000 },
    { keywords: ['pantalla', 'tv', 'televisión', 'television', 'smart tv'], maxPrice: 45000 },

    // --- TIER 11: PHOTOGRAPHY & ACTION CAMS ---
    { keywords: ['cámara reflex', 'camara reflex', 'cámara mirrorless', 'camara mirrorless', 'nikon z', 'sony alpha', 'canon eos r'], maxPrice: 75000 },
    { keywords: ['cámara', 'camara', 'gopro', 'go pro', 'cámara de acción', 'camara de accion'], maxPrice: 15000 },

    // --- TIER 12: AUDIO SYSTEMS & SOUNDBARS ---
    { keywords: ['bose smart', 'sonos arc', 'sonos beam', 'sony ht', 'jbl bar'], maxPrice: 32000 },
    { keywords: ['barra de sonido', 'soundbar', 'bocina', 'bocinas', 'bafle'], maxPrice: 8000 },
...
export const OFFICE_RULES: PriceGuardRule[] = [
    ...
    { keywords: ['laptop gamer', 'laptop gaming', 'computadora gamer', 'computadora gaming', 'pc gamer', 'pc gaming'], maxPrice: 75000 },
